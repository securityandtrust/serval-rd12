package lu.snt.iot.serval.rn12.doorlock.cmp;

import lu.snt.iot.serval.rn12.doorlock.core.DoorClass;
import lu.snt.iot.serval.rn12.doorlock.MainLock;
import lu.snt.iot.serval.rn12.doorlock.core.DoorListener;
...
@ComponentType
public class DoorComponent extends AbstractComponentType implements DoorListener {
